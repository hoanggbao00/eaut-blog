/**
 * This component is inspired by `shadcn-ui-date-time-picker` and thanks to `@uncvrdfor` creating this.
 * reference: https://shadcnui-expansions.typeart.cc/docs/datetime-picker
 * Author: [@uncvrdfor](https://github.com/uncvrd)
 */
...
>(({ jsDate, onJsDateChange, showClearButton = true, ...props }, ref) => {
  ...
  const [jsDatetime, setJsDatetime] = useState(jsDate || undefined);
